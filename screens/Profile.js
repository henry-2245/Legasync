...
const Profile = ({ isYourOwnProfile }) => {
  ...
  const optionContainerStyles = useMemo(() => {
    return [
      ...
      isYourOwnProfile ? styles.optionContainerOwnProfile : styles.optionContainerOtherProfile,
    ];
  }, [isYourOwnProfile]);
      ...
      {!isYourOwnProfile && (
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statsRow} >
            <TouchableOpacity onPress={() => setShowFollowerPopup(true)} style={{textAlign: "center",flex: 1, alignItems: 'center'}} >
          ...
          <View style={styles.statsRow} >
            <TouchableOpacity onPress={() => setShowFollowingPopup(true)} style={{textAlign: "center", flex: 1, alignItems: 'center'}}>
